...
import { Mail, Lock, User, Phone, Loader2, UserCircle, Upload, X } from 'lucide-react';
...
export function SignUpForm() {
  ...
  return (
    <motion.div {...animations.fadeIn} transition={{ duration: 0.3 }}>
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle>Create Account</CardTitle>
          <CardDescription>Join KachraMart and start making a difference</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="citizen">Citizen (Waste Generator)</SelectItem>
                  <SelectItem value="collector">Collector (Pickup Service)</SelectItem>
                  <SelectItem value="dealer">Dealer (Recycler/Buyer)</SelectItem>
                </SelectContent>
              </Select>
            </div>
